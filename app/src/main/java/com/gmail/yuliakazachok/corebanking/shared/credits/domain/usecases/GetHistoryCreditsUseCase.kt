...
class GetHistoryCreditsUseCase @Inject constructor(private val repository: CreditsRepository) {

    suspend operator fun invoke(numberPassport: Long): List<Credit> =
        repository.getHistoryCredits(numberPassport)
}